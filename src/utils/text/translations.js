...
export const uiTexts = {
  ...
  pl: {
    ...
    holdToSpeak: "Kliknij aby mówić",
    processing: "Przetwarzanie...",
    speaking: "Mówi...",
    listening: "Słucham...",
    voiceScreen: "Ekran głosowy",
    newChatCreated: "Nowy czat z Omnia utworzony",
    audioStopped: "Audio zatrzymane",
    streamingStopped: "Transmisja zatrzymana",
    clickToStop: "kliknij aby zatrzymać",
    clickToReturn: "kliknij aby wrócić",
    clickToSpeak: "kliknij aby mówić",
    error: "Błąd",
    omniaStreaming: "Omnia mówi...",
    omniaPreparingResponse: "Omnia przygotowuje odpowiedź...",
    omniaSpeaking: "Omnia mówi...",
    thinking: "Myśli...",
    searching: "Szuka...",
    streamingRealTime: "Rozmawia z tobą w czasie rzeczywistym",
    advancedAIAssistant: "Zaawansowany asystent AI",
    streaming: "mówi",
    or: "lub",
    searchError: "Błąd wyszukiwania",
    connectionError: "Błąd połączenia - spróbuj ponownie",
    voiceError: "Błąd rozpoznawania mowy - spróbuj ponownie",
    voicePermissionError: "Nie udało się uzyskać dostępu do mikrofonu",
    apiError: "Błąd serwera API",
    unknownError: "Nieoczekiwany błąd",
    retryAction: "Kliknij aby powtórzyć",
    chatHistory: "Historia czatu i ustawienia",
    newChatButton: "Nowy czat",
    multimodalFeatures: "Funkcje multimodalne",
    deepSearch: "Głębokie wyszukiwanie",
    generateImage: "Wygeneruj obraz",
    plusMenu: "Menu plus (wkrótce)",
    chatPlaceholder: "Czatuj z Omnia...",
    imageGenerated: "🎨 Wygenerowany obraz:",
    
    // Auth Modal texts
    welcomeToOmnia: "Witaj w Omnia",
    pleaseSignIn: "Zaloguj się na swoje konto",
    createNewAccount: "Utwórz nowe konto",
    confirmRegistration: "Potwierdzenie rejestracji",
    enterCodeFromEmail: "Wprowadź 6-cyfrowy kod z emaila aby potwierdzić konto",
    email: "Email",
    password: "Hasło",
    signIn: "Zaloguj się",
    ...
    registrationSuccessful: "Rejestracja przebiegła pomyślnie! Wprowadź kod z emaila.",
    accountConfirmed: "Konto pomyślnie potwierdzone!",
    ...
    enterEmailForReset: "Wprowadź email, a wyślemy ci kod do resetu hasła",
    enterCodeFromEmailReset: "Wprowadź 6-cyfrowy kod z emaila",
    setNewPassword: "Ustaw nowe hasło dla swojego konta",
    enterNewPassword: "Wprowadź nowe hasło dla swojego konta",
    ...
    codeVerified: "Kod zweryfikowany! Teraz ustaw nowe hasło.",
    passwordChanged: "Hasło pomyślnie zmienione!",
    newCodeSent: "Nowy kod wysłany!",
    ...
    deleteConfirmation: "Czy na pewno usunąć '{title}'? Tej akcji nie można cofnąć.",
    noConversations: "Brak rozmów",
    deleteChat: "Usuń czat",
    delete: "Usuń",
    deleteConfirmShort: "Naprawdę usunąć czat '{title}'?",
    omniaThinking: "Omnia myśli...",
    tapMicrophoneToStop: "Kliknij mikrofon aby zatrzymać",
    talkWithOmnia: "Rozmawiaj z Omnia",
    featuresComingSoon: "Funkcje będą dostępne wkrótce",
    aiCanMakeErrors: "AI może popełniać błędy, przeprowadź własne badania",
    loadingProfile: "Ładowanie profilu...",
    fullName: "Pełne imię i nazwisko",
    howYouWantToBeDisplayed: "Jak chcesz być wyświetlany",
    aiGreeting: "Powitanie AI",
    howAiShouldAddressYou: "Jak AI powinno się do ciebie zwracać",
    exampleNicknames: "Np. \"professor\", \"daddy\", \"John\", \"Tom\" 😄",
    saving: "Zapisywanie..."
  }
};
