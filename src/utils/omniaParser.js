      ...
      if (inCodeBlock) {
        ...
        processedLines.push(`
          <div class="omnia-code-block">
            <button 
              class="absolute top-2 right-2 p-1.5 text-gray-400 hover:text-white transition-colors duration-200 rounded-md hover:bg-white/5 border-none bg-transparent z-10"
            ...
            >
              ...
              <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="check-icon text-green-400 hidden">
